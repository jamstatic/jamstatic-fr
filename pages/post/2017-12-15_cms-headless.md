...
![Aperçu d’une architecture de CMS découplée](https://res.cloudinary.com/jamstatic/image/upload/f_auto,q_auto/v1523346944/jamstatic/headless-cms-schema.png "Aperçu d’une architecture de [CMS découplée](https://www.storyblok.com/tp/headless-cms-explained)")
...
[Distinguons les CMS headless](page:post/git-based-cms-vs-api-first-cms) qui vous permettent de modifier les fichiers de votre dépôt Git ([Forestry](https://forestry.io), [Siteleaf](https://siteleaf.com), [Netlify CMS](page:post/configurer-netlify-cms-pour-jekyll), etc.) de ceux qui mettent vos contenus à disposition via une API ([Contentful](https://www.contentful.com/), [Prismic](https://prismic.io/), [Directus](https://getdirectus.com/), [GraphCMS](https://graphcms.com/), etc.).

Chris Macrae détaille la différence entre les deux approches dans [cette vidéo](https://www.youtube.com/watch?v=KX4G49ZrvY0).
