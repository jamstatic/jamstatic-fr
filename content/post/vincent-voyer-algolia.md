...
développeur freelance, je suis allé à DotJS, il y avait un stand Algolia, je suis
...
un OU, il n'y a pas de tolérance aux fautes de frappe, c'est pas super.

Je repasse devant le stand Algolia et là il y avait une énergie, il y avait Alexandre
...
les données des utilisateurs. Et comme il fallait que ce SDK tourne sur tous les
...
En fait ils le proposaient, ça s'appelait [Google Site Search](https://enterprise.google.com/search/products/gss.html), ils proposaient
...
{{< figure src="/assets/images/algolia-smashing.png" caption="La recherche de la nouvelle version de Smashing Magazine avec Algolia" >}}
