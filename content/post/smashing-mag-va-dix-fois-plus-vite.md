...
-   **GoCommerce** — une petite API en Go pour les sites e-commerce pour la gestion des commandes et des paiements,
...
Une des tâches les plus importantes liées au travail pour Smashing a été sans conteste le projet de gestionnaire de contenus open source **[Netlify
...
…et la JAMStack a prouvé qu'elle est une figure de proue de la renaissance du Web moderne et nous avons été capable d’achever tout ce travail tout en fournissant une boîte à outil open source pour la communauté.
