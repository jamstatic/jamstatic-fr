...
C'est toujours bluffant de voir à quel point l'intégration de tels services a été pensée pour être la plus simple possible pour les développeurs. Dans cet exemple, Marty a utilisé le plugin [jekyll-algolia](https://github.com/algolia/jekyll-algolia) développé par Tim Carry, passé ingénieur open-source à plein temps chez Algolia.
